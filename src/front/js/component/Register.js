...
export const Register = () => {
    return (
        ...
        //<button type="button" class="btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#exampleModal">Register</button>
        ...
        <
        h1 class = "modal-title fs-3  d-flex justify-content-center"
        ...
        div id = "emailHelp"
        class = "form-text d-flex justify-content-start" >
        Al hacer clic en Crear nueva cuenta, aceptas los Términos y condiciones de uso. <
        /div> <
        button type = "button"
